...
<form action="http://leish-esp.cbm.uam.es/publications.html"> 
	...
	<div class="thumbnail" style="background-color:#f4ffdd; padding:20px">
      <ul>
      <h4><font color="red"><em>News!</em></font></h4>
      <ul>
      <li>
...
<h2>Gene finder</h2>
			...
			<ul>
			<br>
			<b>Write the gene ID or function in which you are interested</b>:
			<br>
			<br>
			<form action="plantilla_2_Resultado_busqueda_2.php" method="post">
            <center><input type="text" name="valueToSearch" placeholder="Gene ID"; style="width: 200px; padding: 10px; font-size: 1.0vw"></center><br>
            <center><input class="slideDownOne" target="_blank" type="submit"  name="search" value="Filter" style= "width: 125px; padding: 8px; cursor: pointer;background:#850B27; color:#f1f1f1; font-weight: bold; border-radius: 10px; border: 1px solid #999; font-size: 0.8vw"></center>
      <br>
	<br>
	<br>
        </form>
