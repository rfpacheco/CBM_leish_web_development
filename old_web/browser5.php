...
<body>
	...
	<ul>
      ...
      <br>
        ...
        <form action="browser5.php" method="post">
	...
	<div class="table-responsive">
      ...
      <!-- populate table from mysql database -->
	    ...
	    <table>
		<tr>
                    <th height="45"><h4><ul>Additional Information</ul></h4></th>
		    <th><h4><ul>Associated Function</ul></h4></th>
                </tr>
		<?php while($row2 = mysqli_fetch_array($search_result)):?>
 		<tr>
		    <td><?php echo $row2['AdditionalInformation'];?></td>
                    <td><?php echo $row2['AssociatedFunction'];?></td>
                </tr>
                <?php endwhile;?>
