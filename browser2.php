...
<body>
      ...
      <br>
	<ul>
        <p>Here's an interactive Browser with the genome and the transcriptome annotation in <em>L. major</em> based on <a href="https://doi.org/10.3390/genes12091359" target="_blank"" target="_blank"> <b><em>Camacho et al.</em></b></a> version of the genome.</p>
      ...
      <div class="container">
                       ...
                       <iframe src="http://leish-esp.cbm.uam.es/viewer/JBrowse-1.12.3/?data=majorCBM&loc=LmjFc.01%3A119321..131770&tracks=DNA%2C1_alignment-track%2C2_SL-track%2C3_polyA-track%2CLmjFc_cbm_genome_annotation&highlight="  allowtransparency="true" style="position:absolute; left:80px; right:30px; width:90%; height:400px; margin:0; padding:10px; border: 5px groove; background: #ECFFE0;"></iframe> 
                    </div>
            </div><!--//container-->
      <br>
      <br>
