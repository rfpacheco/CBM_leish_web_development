...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `Lbraz` WHERE CONCAT(`CDSID`, `ortholog`, `AssociatedFunction`) LIKE '%".$valueToSearch."%'";
    $search_result = filterTable($query);
    
}
 else {
    $query = "SELECT * FROM `Lbraz`";
    $search_result = filterTable($query);
}
...
<html>
	...
	<head>
		<meta charset="utf-8">
		<title>Browser L. braziliensis</title>
	...
	<br>
		<div><a href="http://leish-esp.cbm.uam.es/index.html" style="text-decoration:none" ><center><h2><font color="white"><b>Leish-ESP:</b></font></h2> <h3><font color="white"><em>Leishmania braziliensis</em> Browser</font></h3></center></a></div>
    </header>
    <img src="/img/braziliensis_pequeno.png" alt="major_cut" style="width: 50%; height: 50px">
    ...
    <body>
      ...
      <br>
	<ul>
        <p>Here's an interactive Browser with the genome annotation in <em>L. braziliensis</em> based on <a href="https://babia.cbm.uam.es:5001/sharing/pkeb4TxPR"><b>González-de la Fuente </b></a>version of the genome (2018).</p>
      ...
      <div class="container">
                        ...
                        <iframe src="http://leish-esp.cbm.uam.es/viewer/JBrowse-1.12.3/?data=braziliensis&tracks=DNA%2CLbraz_cbm_genome_annotation&highlight="  allowtransparency="true" style="position:absolute; left:80px; right:30px; width:90%; height:400px; margin:0; padding:10px; border: 5px groove; background: #E0EAEA;"></iframe>
                    </div>
            </div><!--//container-->	
      <br>  
      <br>
      ...
      <br>
      <br>
      <h3 id="Table"><b><em>Leishmania braziliensis </em>orthologs in <em>Leishmania major </em>:</b></h3>
      </ul>
      <p>
      <ul>
      <ul>
      <br>
      <p>Here's a table with information about <em>L. braziliensis</em> CDSs and their associated orthologs in <em>L. major</em> 
      <p>You can look for any particular CDS by any of the fields using the searcher. </p>
      </ul>
      </ul>
        <form action="browser_ortholog_Lbraz.php" method="post">
